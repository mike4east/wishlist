        ...
        <div class="col-md-5">
            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror samazon-login-input" name="name" value="{{ $user->name }}" required autocomplete="name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control @error('postal_code') is-invalid @enderror samazon-login-input" name="postal_code" value="{{ $user->postal_code }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control @error('address') is-invalid @enderror samazon-login-input" name="address" value="{{ $user->address }}" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control @error('phone') is-invalid @enderror samazon-login-input" name="phone" value="{{ $user->phone }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror samazon-login-input" name="email" value="{{ $user->email }}" required autocomplete="email">
